#!/usr/bin/env python3
"""
MAY/JUNE 2025 BACKTEST - FIXED MTF MERGE
Based on validated methodology.
Data source: Binance (May 1 - July 1, 2025)
"""
...
if __name__ == "__main__":
    results_may = run_backtest("MAY 2025", '/Users/alifiyaa/Downloads/quantEngineHyperliquid/MANDALORIAN_ENGINE/may2025_binance_data.csv')
    results_june = run_backtest("JUNE 2025", '/Users/alifiyaa/Downloads/quantEngineHyperliquid/MANDALORIAN_ENGINE/june2025_binance_data.csv')
