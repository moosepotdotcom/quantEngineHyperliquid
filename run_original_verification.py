#!/usr/bin/env python3
"""
EXACT COPY of original verify_adaptive_shield_v2.py
Running on MANDALORIAN_ENGINE models
"""
...
def run_adaptive_shield_v2():
    print("🛡️ ADAPTIVE SHIELD V2: SIMULATION (JAN 2 - JAN 17)")
    print("="*70)
    print("Logic:")
    ...
    df_raw['hurst'] = 0.5  # Default hurst
    ...
    # 2. Filter Date Range (Jan 2 - Jan 17)
    start_sim = pd.Timestamp("2026-01-02 00:00:00")
    end_sim = pd.Timestamp("2026-01-17 23:59:59")
    ...
    for idx, row in sim_data.iterrows():
        ...
        # Predict - USING DIRECT MODEL CALLS (ORIGINAL METHOD)
    ...
    print("\n" + "="*70)
    print(f"📊 ADAPTIVE SHIELD V2 RESULTS (Jan 2 - Jan 17)")
