...
gcloud run deploy $SERVICE_NAME \
  ...
  --cpu 2 \
  --timeout 3600 \
  --set-env-vars="HYPERLIQUID_WALLET_ADDRESS=0xc692111d70b42e32e7b87abdd7dae7900b6cdde1,ENABLE_LIVE_TRADING=$ENABLE_LIVE,USE_TESTNET=$USE_TESTNET,MAX_POSITION_SIZE=0.01,MAX_LEVERAGE=2,DAILY_LOSS_LIMIT=5.0,WINNER_HUNTER_MIN_CONFIDENCE=0.30,MTF_SCALPER_MIN_CONFIDENCE=0.25" \
