...
def run_gem_simulation():
    print("💎 GEM SNIPER: SIMULATION (ATR HARD LIMIT)")
    print("="*70)
    ...
    # ATR Limits to verify (Only Ultra)
    limit = 52.75
    
    print(f"\n🔍 VERIFYING GEM SNIPER ULTRA (ATR < {limit})")
