...
def run_standard_simulation():
    print("💎 GEM SNIPER STANDARD (ATR < 60.00): JAN 2 - JAN 7")
    print("="*70)
    
    engine = TradingEngine()
    
    # 1. Fetch Data
    # Only need recent history for Jan 2026, fetch limit 4000 (enough for 5m)
    # Using fetch_data from engine which handles the API call
    ...
    # 2. Filter Date Range (Jan 2 to Jan 7)
    start_sim = pd.Timestamp("2026-01-02 00:00:00")
    end_sim = pd.Timestamp("2026-01-07 23:59:59")
    ...
    print("\n" + "="*70)
    print(f"📊 STANDARD VERIFICATION RESULTS (Jan 2 - Jan 7)")
