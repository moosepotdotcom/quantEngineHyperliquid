...
def run_jan7_10_verification():
    print("💎 GEM SNIPER: JAN 7 - JAN 10 VERIFICATION")
    print("="*70)
    
    engine = TradingEngine()
    # Fetch ample data to ensure we cover the range
    ...
    print(f"✅ Data Ready: {len(sim_data)} rows (Jan 7-10).")
    
    # Gem Sniper Ultra Limit
    limit = 52.75
    
    print(f"\n🔍 GEM SNIPER ULTRA (ATR < {limit}) - JAN 7-10 LOG")
