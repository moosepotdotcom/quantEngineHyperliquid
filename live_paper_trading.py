    ...
    while True:
        try:
            ...
            if not tracker.position:
                ...
                state.update_signal(prob_long, prob_short, current_price)
            ...
            # Sleep before next iteration (reduced for faster updates)
            print(f"💤 Sleeping 5s... (Price: ${current_price:,.0f}) | LONG: {prob_long:.1%} | SHORT: {prob_short:.1%}")
            time.sleep(5)
