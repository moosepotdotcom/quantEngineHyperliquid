...
TP_PCT = 0.002
SL_PCT = 0.001
MIN_BODY_PCT = 0.0003 # 0.03% Min Body Size for Breakout
STATE_FILE = "LIQUIDATION_SCALPER/bot_state.json"
            ...
            for t in trades:
                ...
                if now_min != last_minute:
                    ...
                    if current_candle['vol'] > MOMENTUM_THRESHOLD_VOL:
                         # CHOP FILTER
                         body_pct = abs(current_candle['close'] - current_candle['open']) / current_candle['open']
