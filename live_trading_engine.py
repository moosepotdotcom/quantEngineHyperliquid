...
class LiveTradingEngine:
    ...
    def __init__(self, enable_live: bool = False, testnet: bool = True):
        ...
        # Dashboard Proxy Attributes (Expose paper_engine agents for UI)
        self.whale_watcher = self.paper_engine.whale_watcher if hasattr(self.paper_engine, 'whale_watcher') else None
        self.liq_monitor = self.paper_engine.liq_monitor if hasattr(self.paper_engine, 'liq_monitor') else None
        self.funding_monitor = self.paper_engine.funding_monitor if hasattr(self.paper_engine, 'funding_monitor') else None
        self.info = self.paper_engine.info if hasattr(self.paper_engine, 'info') else None
