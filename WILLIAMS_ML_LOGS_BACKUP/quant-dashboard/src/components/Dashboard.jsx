...
export default function Dashboard() {
    ...
    const toggleFilter = async () => {
        const newState = !account.filter_enabled;
        try {
            await axios.post(`${API_URL}/settings/filter`, { enabled: newState }, getAuthHeaders());
            setAccount(prev => ({ ...prev, filter_enabled: newState }));
        } catch (e) {
