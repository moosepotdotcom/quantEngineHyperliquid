...
class CopyTradingEngine:
    ...
    def update_subscriber(self, user_id, wallet=None, key=None, risk=None):
        ...
        if key: sub['key'] = key
        if risk: sub['risk'] = risk
        
        self.subscribers[user_id] = sub
        self.save_subscribers()
        print(f"🔄 Updated subscriber: {user_id}")
        return True, "Subscriber updated"
